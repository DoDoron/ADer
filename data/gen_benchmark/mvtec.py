...
class MVTecSolver(object):
    ...
    def __init__(self, root='content/gdrive/MyDrive/PiLab/Dataset/MVTecAD', is2D=True):
        self.root = root
        self.is2D = is2D
...
if __name__ == '__main__':
    runner = MVTecSolver(root='content/gdrive/MyDrive/PiLab/Dataset/MVTecAD', is2D=True)
    runner.run()
